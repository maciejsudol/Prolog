...
rodzina(
    osoba(jan,pogocki,data(2,listopada,1999),pracuje(blog,10000)),
    osoba(patrycja,dzenisik,data(3,grudnia,1991),pracuje(agh,100)),
    [
	osoba(julka,pogocka,data(13,kwiecien,1990),zasilek)]
).
